...
function totalPopulation(states){
  ...
  return utahScore + californiaScore + texasScore + arizonaScore
...
let{utah: utahScore, california: californiaScore, texas: texasScore, arizona:arizonaScore} = states
...
function ingredients(objs){
  return array = [carbs, fats, proteins]
}
...
let {carb: carbs, fat: fats, protein: proteins} = objs

// console.log(ingredients(objs))
...
let mittens = new Cat('Mittens', 10, 'White')
  // console.log(mittens)
...
let harry = new Wizard('Harry Potter', 17, 'Stupify')
// harry.castSpell()
...
class Phone {
  ...
  changePrice(newPrice){
    ...
    console.log(`This ${this.model}'s price has been lowered to ${newPrice}.`)
  }
}
...
//Code Here
  let iPhone = new Phone('Apple', 'iPhone', 64 , 'black', 500)
  let andriod = new Phone('Andriod', 'idk', 128 , 'white', 250)
  let flip = new Phone('LG', 'Flip phone', 2 , 'silver', 50)
...
let myFirstVehicle = new Vehicle(5, 'black', 4000)
...
//Code Here 
let myFirstMotorcycle = new Motorcylce(2, "silver", 200, 'hd', true)
/*
...
let boat = new Boat('10', 'white', '5000', 'yacht', true, 'Yeet', "Yacht", false)
